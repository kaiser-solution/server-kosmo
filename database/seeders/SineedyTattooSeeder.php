        ...
        $recordTypes = [
            ...
            [
                ...
                'schema' => [
                    ...
                    'x-institutions' => [
                        ['name' => 'Aluguel Casa',             'defaultVal' => 1800.00, 'dueDay' => 15,  'category' => 'Casa', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Energia Elétrica Casa',    'defaultVal' => 350.00,  'dueDay' => 23,  'category' => 'Casa', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Água e Esgoto Casa',       'defaultVal' => 250.00,  'dueDay' => 13,  'category' => 'Casa', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Internet Fibra Casa',      'defaultVal' => 125.00,  'dueDay' => 10,  'category' => 'Casa', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Aluguel Estudio',          'defaultVal' => 1700.00, 'dueDay' => 5,   'category' => 'Estúdio', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Água e Luz Estudio',       'defaultVal' => 550.00,  'dueDay' => 5,   'category' => 'Estúdio', 'tracking_since' => $trackingSinceDefault],
                        ...
                        ['name' => 'Seguro de Vida',           'defaultVal' => 105.00,  'dueDay' => 20,  'category' => 'Saúde', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Cartão Denis',             'defaultVal' => 1500.00, 'dueDay' => 10,  'category' => 'Cartões', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Cartão Roldão',            'defaultVal' => 1000.00, 'dueDay' => 20,  'category' => 'Cartões', 'tracking_since' => $trackingSinceDefault],
                        ['name' => 'Telefone Dani',            'defaultVal' => 44.00,   'dueDay' => 10,  'category' => 'Comunicação', 'tracking_since' => $trackingSinceDefault],
